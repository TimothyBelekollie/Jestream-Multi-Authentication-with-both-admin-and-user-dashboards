...
<div class="col-md-6">
 ...
 <form action="{{route('admin.profile.store')}}" method="POST" enctype="multipart/form-data">
  @csrf
    <div class="mb-3">
     <img id="showImage" style=" width:100px; height:100px; margin-left:20px;" src="{{(!empty($editData->profile_photo_path ))? url('upload/admin_images/'.$editData->profile_photo_path):url('upload/no_image.jpg')}}">
      </div>
