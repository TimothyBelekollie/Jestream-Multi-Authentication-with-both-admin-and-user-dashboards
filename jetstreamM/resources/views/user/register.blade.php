        ...
        <div class="preloader">
            ...
            <div class="content_wrapper">
                ...
                <div class="registration_page center_container">
                    <div class="center_content">
                        <div class="logo">
                            <img src="{{('userbackend/panel/assets/images/logo.png')}}" alt="" class="img-fluid">
                        </div>
         ...
         <input id="email" type="email" class="form-control" name="email" value=" " required autocomplete="email" placeholder="Email Address">
                            ...
                            <div class="form-group">
                                <a class="registration" href=" {{ route('user.login') }}">Already have an account</a><br>
                                <button type="submit" class="btn btn-blue">Signup</button>
                            </div>
                        </form>
                        <div class="footer">
                            <p>Copyright &copy; 2022 <a href="">TimXperience</a>. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div><!--/ content wrapper -->
